              ...
              child: Stack(
                ...
                children: [
                  ...
                  Positioned(
                    top: 6,
                    right: 6,
                    child: _RatingChip(rating: flower.rating), //untuk manggil rating
                  ),
                  Positioned(
                    top: 6,
                    right: 6,
                    child: ValueListenableBuilder<Set<String>>(
                      valueListenable: FavoriteController.intance, //favoriteControlller.intance
                      builder: (context, favorite, _) {
                        final isFav = favorite.contains(flower.id);
                        return InkWell(
                          borderRadius: BorderRadius.circular(20),
                          onTap: () => FavoriteController.intance.toggle(flower.id), //FavController.intance
                          child: CircleAvatar(
                            radius: 16,
